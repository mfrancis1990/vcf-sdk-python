...
"""
Demonstrates how to configure online depot and download bundles necessary for deploying
a new VCF Fleet with its first VCF Instance. This includes the following components:
VCF Operations Fleet Management, VCF Operations, VCF Operations Collector, VCF Automation,
