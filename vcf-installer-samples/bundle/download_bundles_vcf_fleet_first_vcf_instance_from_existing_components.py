...
"""
Demonstrates how to configure online depot and download bundles necessary for
deploying a new VCF Fleet with its first VCF Instance,
assuming that you already have vCenter and NSX deployed.
